...
export const About = () => {
  ...
  useEffect(() => {
    document.title = "About - Honeybee Clicker";
  }, []);
  ...
  return (
    <>
      ...
      >
        <AboutContainer>
          <AboutTitle>About Honeybee Clicker</AboutTitle>
          <AboutText>
            <b>Welcome to Honeybee Clicker!</b> This is a simple yet addictive
          ...
          <AboutText>
            ...
            achievements. To customize your Honeybee Clicker profile, you can
          ...
          <AboutText>
            ...
            available to unlock in Honeybee Clicker. These include achievements for
          ...
          <AboutText>
            <b>Honeybee Clicker is a Progressive Web App. </b>
          ...
          <AboutText>
            Made with  LOVE by{" "}
            <AboutLink href="https://github.com/bouzayenilyes" target="_blank">
             Ilyes Bouzayen
            </AboutLink>{" "}
          ...
          <Stack spacing={2} direction="row">
            <Button
              href="https://github.com/bouzayenilyes/honeybee"
              target="_blank"
              variant="outlined"
              style={{
                fontSize: ".9rem",
            ...
            <Button
              href="https://www.buymeacoffee.com/bouzayenilyes"
              target="_blank"
              variant="outlined"
              style={{
                fontSize: ".9rem",
